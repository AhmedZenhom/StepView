...
public class BasicVerticalForwardFragment extends Fragment {

  private VerticalStepView mVerticalStepView;

  public BasicVerticalForwardFragment() {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    return inflater.inflate(R.layout.fragment_basic_vertical_forward, container, false);
  }
